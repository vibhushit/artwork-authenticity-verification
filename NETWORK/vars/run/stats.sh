...
let oked=0
let total=0
declare -a allpeernodes=(peer1.expert.art.com peer1.artist.art.com peer1.gallery.art.com)
...
declare -a allorderernodes=(orderer1.art.com orderer2.art.com orderer3.art.com)
