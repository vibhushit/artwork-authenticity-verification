...
jq '.channel_group.groups.Application.groups."gallery-art-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.221.156","port": 7005}]},"version": "0"}}' artchannel_current_config.json > artchannel_modified_anchor_config.json
